...
update public.subjects set grade_max = 6 where id in ('math', 'german', 'english', 'science', 'geography', 'computer-science');
update public.subjects set grade_min = 3, grade_max = 6 where id = 'history';

insert into public.topics (id, subject_id, module_id, title, grade_min, grade_max) values
  ('de-spelling', 'german', 'german-spelling', 'Richtig schreiben', 1, 6),
  ('de-grammar', 'german', 'german-grammar', 'Grammatik verstehen', 2, 6),
  ('de-punctuation', 'german', 'german-punctuation', 'Zeichen setzen', 3, 6),
  ('de-reading', 'german', 'german-reading', 'Texte verstehen', 2, 6),
  ('en-vocabulary', 'english', 'english-vocabulary', 'Wörter verstehen', 1, 6),
  ('en-grammar', 'english', 'english-grammar', 'Sätze bauen', 3, 6),
  ('en-dialogues', 'english', 'english-dialogues', 'Dialoge führen', 3, 6),
  ('en-reading', 'english', 'english-reading', 'Englische Texte lesen', 4, 6),
  ('science-body-topic', 'science', 'science-body', 'Körper & Gesundheit', 1, 6),
  ('science-animals-topic', 'science', 'science-animals', 'Tiere & Pflanzen', 1, 6),
  ('science-weather-topic', 'science', 'science-weather', 'Wetter & Klima', 2, 6),
  ('science-energy-topic', 'science', 'science-energy', 'Energie & Experimente', 3, 6),
  ('science-space-topic', 'science', 'science-space', 'Erde & Weltall', 4, 6),
  ('history-timeline-topic', 'history', 'history-timeline', 'Zeitstrahl nutzen', 3, 6),
  ('history-sources-topic', 'history', 'history-sources', 'Quellen untersuchen', 4, 6),
  ('history-daily-topic', 'history', 'history-daily-life', 'Alltag früher', 3, 6),
  ('history-eras-topic', 'history', 'history-eras', 'Epochen kennen', 5, 6),
  ('geo-orientation', 'geography', 'geography-orientation', 'Karten lesen', 3, 6),
  ('geo-germany', 'geography', 'geography-germany', 'Deutschland kennen', 3, 6),
  ('geo-europe', 'geography', 'geography-europe', 'Europa kennen', 4, 6),
  ('geo-scale', 'geography', 'geography-scale', 'Maßstab nutzen', 5, 6),
  ('geo-climate', 'geography', 'geography-climate', 'Klima verstehen', 4, 6),
  ('cs-patterns-topic', 'computer-science', 'cs-patterns', 'Muster & Logik', 3, 6),
  ('cs-algorithms-topic', 'computer-science', 'cs-algorithms', 'Algorithmen bauen', 3, 6),
  ('cs-data-topic', 'computer-science', 'cs-data', 'Daten verstehen', 4, 6),
  ('cs-binary-topic', 'computer-science', 'cs-binary', 'Binärzahlen', 5, 6)
on conflict (id) do update set
  subject_id = excluded.subject_id,
  module_id = excluded.module_id,
  title = excluded.title,
...
insert into public.skills (id, subject_id, topic_id, module_id, title, grade_min, grade_max, description) values
  ('number-line', 'math', 'math-arithmetic', 'arithmetic', 'Zahlenstrahl nutzen', 1, 6, 'Sprünge und Positionen sicher bestimmen'),
  ('math-pyramid', 'math', 'math-arithmetic', 'arithmetic', 'Rechenmauern lösen', 2, 6, 'Summenstrukturen erkennen'),
  ('chart-read', 'math', 'math-data', 'statistics', 'Diagramme lesen', 4, 6, 'Werte aus Tabellen und Diagrammen entnehmen'),
  ('spelling-error', 'german', 'de-spelling', 'german-spelling', 'Rechtschreibfehler finden', 1, 6, 'Merkwörter und typische Fehler erkennen'),
  ('sentence-parts', 'german', 'de-grammar', 'german-grammar', 'Satzglieder bestimmen', 3, 6, 'Subjekt, Prädikat und Objekt erkennen'),
  ('punctuation', 'german', 'de-punctuation', 'german-punctuation', 'Satzzeichen setzen', 3, 6, 'Aussage, Frage und Ausruf unterscheiden'),
  ('reading-detail', 'german', 'de-reading', 'german-reading', 'Textdetails finden', 2, 6, 'Informationen aus kurzen Texten entnehmen'),
  ('english-question', 'english', 'en-grammar', 'english-grammar', 'Englische Formen einsetzen', 3, 6, 'am, is, are und einfache Fragen verwenden'),
  ('english-dialogue', 'english', 'en-dialogues', 'english-dialogues', 'Dialoge ergänzen', 3, 6, 'Passende Antworten im Gespräch auswählen'),
  ('english-reading-detail', 'english', 'en-reading', 'english-reading', 'Englische Texte verstehen', 4, 6, 'Details in kurzen englischen Texten finden'),
  ('plant-parts', 'science', 'science-animals-topic', 'science-animals', 'Pflanzenteile kennen', 1, 6, 'Aufgaben von Wurzel, Blatt und Blüte verstehen'),
  ('food-chain', 'science', 'science-animals-topic', 'science-animals', 'Nahrungsketten ordnen', 3, 6, 'Produzenten und Konsumenten einordnen'),
  ('water-cycle', 'science', 'science-weather-topic', 'science-weather', 'Wasserkreislauf verstehen', 2, 6, 'Verdunstung, Wolken und Niederschlag erklären'),
  ('experiment', 'science', 'science-energy-topic', 'science-energy', 'Experimente auswerten', 3, 6, 'Faire Versuche und Beobachtungen verstehen'),
  ('space', 'science', 'science-space-topic', 'science-space', 'Erde und Weltall verstehen', 4, 6, 'Tag/Nacht, Mond und Planeten einordnen'),
  ('century', 'history', 'history-timeline-topic', 'history-timeline', 'Jahrhunderte bestimmen', 4, 6, 'Jahre auf dem Zeitstrahl einordnen'),
  ('daily-life', 'history', 'history-daily-topic', 'history-daily-life', 'Alltag früher vergleichen', 3, 6, 'Lebensweisen früher und heute unterscheiden'),
  ('federal-states', 'geography', 'geo-germany', 'geography-germany', 'Bundesländer kennen', 3, 6, 'Städte und Bundesländer zuordnen'),
  ('europe', 'geography', 'geo-europe', 'geography-europe', 'Europa kennen', 4, 6, 'Länder und Hauptstädte zuordnen'),
  ('climate', 'geography', 'geo-climate', 'geography-climate', 'Klima verstehen', 4, 6, 'Klimamerkmale und Landschaften verbinden'),
  ('debugging', 'computer-science', 'cs-algorithms-topic', 'cs-algorithms', 'Fehler in Abläufen finden', 4, 6, 'Reihenfolge, Wiederholung und Bedingungen prüfen'),
  ('data', 'computer-science', 'cs-data-topic', 'cs-data', 'Daten sortieren', 4, 6, 'Daten ordnen und Tabellen lesen')
on conflict (id) do update set
  subject_id = excluded.subject_id,
  topic_id = excluded.topic_id,
  module_id = excluded.module_id,
...
insert into public.missions (id, subject_id, module_id, title, description, badge, visual, grade_min, grade_max, target_count, sort_order) values
  ('rechtschreib-agent', 'german', 'german-spelling', 'Rechtschreib-Agent', 'Merkwörter, Dehnung und häufige Fehler sicher erkennen.', 'Fehler-Finder', 'Aa', 1, 6, 6, 12),
  ('grammatik-labor', 'german', 'german-grammar', 'Grammatik-Labor', 'Wortarten, Satzglieder und Zeitformen untersuchen.', 'Grammatik-Profi', 'S', 2, 6, 6, 13),
  ('zeichen-detektiv', 'german', 'german-punctuation', 'Zeichen-Detektiv', 'Satzzeichen, Kommas und wörtliche Rede üben.', 'Zeichen-Profi', '?!', 3, 6, 6, 14),
  ('lese-detektiv', 'german', 'german-reading', 'Lese-Detektiv', 'Kurze Texte verstehen, Details finden und Schlüsse ziehen.', 'Lese-Profi', '📖', 2, 6, 6, 15),
  ('vocabulary-quest', 'english', 'english-vocabulary', 'Vocabulary Quest', 'Alltagswörter sicher verstehen und anwenden.', 'Word Champion', 'EN', 1, 6, 6, 17),
  ('grammar-base', 'english', 'english-grammar', 'Grammar Base', 'Einfache englische Sätze, Fragen und Verneinungen bauen.', 'Grammar Hero', 'is', 3, 6, 6, 18),
  ('dialog-training', 'english', 'english-dialogues', 'Dialog-Training', 'Fragen und Antworten in Alltagssituationen ergänzen.', 'Talk-Profi', 'Hi', 3, 6, 6, 19),
  ('reading-corner', 'english', 'english-reading', 'Reading Corner', 'Kurze englische Texte lesen und verstehen.', 'Reading Hero', 'EN', 4, 6, 6, 20),
  ('koerper-check', 'science', 'science-body', 'Körper-Check', 'Organe, Sinne, Ernährung und Bewegung verstehen.', 'Körper-Profi', '♥', 1, 6, 6, 22),
  ('pflanzen-tierwelt', 'science', 'science-animals', 'Pflanzen & Tierwelt', 'Lebensräume, Pflanzenteile und Nahrungsketten ordnen.', 'Natur-Forscher', '🌱', 1, 6, 6, 23),
  ('wetter-station', 'science', 'science-weather', 'Wetter-Station', 'Wetter messen, Wasserkreislauf und Jahreszeiten erklären.', 'Wetter-Profi', '☁', 2, 6, 6, 24),
  ('energie-labor', 'science', 'science-energy', 'Energie-Labor', 'Strom, Licht, Wärme und Versuchsschritte verstehen.', 'Energie-Forscher', '⚡', 3, 6, 6, 25),
  ('weltall-reise', 'science', 'science-space', 'Weltall-Reise', 'Erde, Mond, Planeten und Tag/Nacht erforschen.', 'Weltall-Profi', '☾', 4, 6, 6, 26),
  ('zeitstrahl-profi', 'history', 'history-timeline', 'Zeitstrahl-Profi', 'Früher, später und Jahrhunderte sicher einordnen.', 'Chronologie-Profi', '⌛', 3, 6, 6, 28),
  ('quellen-forscher', 'history', 'history-sources', 'Quellen-Forscher', 'Historische Quellen erkennen und auswerten.', 'Quellen-Profi', '✉', 4, 6, 6, 29),
  ('alltag-frueher', 'history', 'history-daily-life', 'Alltag früher', 'Schule, Wohnen und Kindheit früher mit heute vergleichen.', 'Alltags-Historiker', '🏠', 3, 6, 6, 30),
  ('epochen-reise', 'history', 'history-eras', 'Epochen-Reise', 'Steinzeit, Antike, Mittelalter und Neuzeit unterscheiden.', 'Epochen-Profi', '🏛', 5, 6, 6, 31),
  ('orientierungs-profi', 'geography', 'geography-orientation', 'Orientierungs-Profi', 'Himmelsrichtungen, Legenden und Kartenzeichen nutzen.', 'Kompass-Profi', 'N', 3, 6, 6, 33),
  ('deutschland-tour', 'geography', 'geography-germany', 'Deutschland-Tour', 'Bundesländer, Städte, Flüsse und Landschaften kennen.', 'Deutschland-Profi', 'DE', 3, 6, 6, 34),
  ('europa-reise', 'geography', 'geography-europe', 'Europa-Reise', 'Länder, Hauptstädte und Nachbarn Europas üben.', 'Europa-Profi', 'EU', 4, 6, 6, 35),
  ('massstab-meister', 'geography', 'geography-scale', 'Maßstab-Meister', 'Entfernungen auf Karten berechnen und vergleichen.', 'Maßstab-Profi', 'km', 5, 6, 6, 36),
  ('klima-forscher', 'geography', 'geography-climate', 'Klima-Forscher', 'Klimazonen, Landschaften und Wetterkarten verstehen.', 'Klima-Profi', '☀', 4, 6, 6, 37),
  ('muster-logik', 'computer-science', 'cs-patterns', 'Muster & Logik', 'Folgen, Bedingungen und Wahr/Falsch-Regeln erkennen.', 'Logik-Champion', '◧', 3, 6, 6, 39),
  ('algorithmus-pfad', 'computer-science', 'cs-algorithms', 'Algorithmus-Pfad', 'Schritte sortieren, Schleifen verstehen und Fehler finden.', 'Algorithmus-Profi', '↻', 3, 6, 6, 40),
  ('daten-detektiv', 'computer-science', 'cs-data', 'Daten-Detektiv', 'Daten ordnen, Tabellen lesen und Codes verstehen.', 'Daten-Profi', '▦', 4, 6, 6, 41),
  ('binary-bits', 'computer-science', 'cs-binary', 'Binary Bits', 'Bits und Binärzahlen in einfache Zahlen umwandeln.', 'Bit-Profi', '01', 5, 6, 6, 42)
on conflict (id) do update set
  subject_id = excluded.subject_id,
  module_id = excluded.module_id,
  title = excluded.title,
...
insert into public.task_templates (id, subject_id, topic_id, module_id, skill_id, title, answer_type, grade_min, grade_max, quality_rules, sort_order) values
  ('tpl-number-line', 'math', 'math-arithmetic', 'arithmetic', 'number-line', 'Zahlenstrahl', 'number', 1, 6, '{"checks":["integer-answer","grade-range"]}'::jsonb, 101),
  ('tpl-math-pyramid', 'math', 'math-arithmetic', 'arithmetic', 'math-pyramid', 'Rechenmauer', 'number', 2, 6, '{"checks":["integer-answer","sum-rule"]}'::jsonb, 102),
  ('tpl-chart-read', 'math', 'math-data', 'statistics', 'chart-read', 'Diagramm lesen', 'number', 4, 6, '{"checks":["single-maximum","integer-answer"]}'::jsonb, 103),
  ('tpl-german-sentence-parts', 'german', 'de-grammar', 'german-grammar', 'sentence-parts', 'Satzglieder bestimmen', 'multiple-choice', 3, 6, '{"checks":["single-correct-option","choices-present"]}'::jsonb, 201),
  ('tpl-german-punctuation', 'german', 'de-punctuation', 'german-punctuation', 'punctuation', 'Satzzeichen wählen', 'multiple-choice', 3, 6, '{"checks":["single-correct-option","choices-present"]}'::jsonb, 202),
  ('tpl-german-reading-detail', 'german', 'de-reading', 'german-reading', 'reading-detail', 'Textdetails finden', 'text', 2, 6, '{"checks":["short-text","unambiguous-answer"]}'::jsonb, 203),
  ('tpl-english-grammar-be', 'english', 'en-grammar', 'english-grammar', 'english-question', 'to be einsetzen', 'fill-blank', 3, 6, '{"checks":["accepted-variants","blank-present"]}'::jsonb, 301),
  ('tpl-english-dialogue', 'english', 'en-dialogues', 'english-dialogues', 'english-dialogue', 'Dialog ergänzen', 'multiple-choice', 3, 6, '{"checks":["single-correct-option","choices-present"]}'::jsonb, 302),
  ('tpl-english-reading-detail', 'english', 'en-reading', 'english-reading', 'english-reading-detail', 'Englischen Text verstehen', 'text', 4, 6, '{"checks":["short-text","unambiguous-answer"]}'::jsonb, 303),
  ('tpl-science-plant-parts', 'science', 'science-animals-topic', 'science-animals', 'plant-parts', 'Pflanzenteile', 'multiple-choice', 1, 6, '{"checks":["single-correct-fact","choices-present"]}'::jsonb, 401),
  ('tpl-science-water-cycle', 'science', 'science-weather-topic', 'science-weather', 'water-cycle', 'Wasserkreislauf', 'multiple-choice', 2, 6, '{"checks":["single-correct-fact","choices-present"]}'::jsonb, 402),
  ('tpl-science-experiment', 'science', 'science-energy-topic', 'science-energy', 'experiment', 'Experiment verstehen', 'multiple-choice', 3, 6, '{"checks":["cause-effect","choices-present"]}'::jsonb, 403),
  ('tpl-science-space', 'science', 'science-space-topic', 'science-space', 'space', 'Erde und Weltall', 'multiple-choice', 4, 6, '{"checks":["single-correct-fact","choices-present"]}'::jsonb, 404),
  ('tpl-history-century', 'history', 'history-timeline-topic', 'history-timeline', 'century', 'Jahrhundert erkennen', 'number', 4, 6, '{"checks":["chronology","integer-answer"]}'::jsonb, 501),
  ('tpl-history-source-type', 'history', 'history-sources-topic', 'history-sources', 'sources', 'Quelle erkennen', 'multiple-choice', 4, 6, '{"checks":["source-type","choices-present"]}'::jsonb, 502),
  ('tpl-history-daily-life', 'history', 'history-daily-topic', 'history-daily-life', 'daily-life', 'Alltag vergleichen', 'multiple-choice', 3, 6, '{"checks":["age-appropriate","choices-present"]}'::jsonb, 503),
  ('tpl-history-eras', 'history', 'history-eras-topic', 'history-eras', 'eras', 'Epochen ordnen', 'ordering', 5, 6, '{"checks":["unique-order","accepted-variants"]}'::jsonb, 504),
  ('tpl-geo-map-symbols', 'geography', 'geo-orientation', 'geography-orientation', 'maps', 'Kartenzeichen', 'multiple-choice', 3, 6, '{"checks":["map-concept","choices-present"]}'::jsonb, 601),
  ('tpl-geo-federal-states', 'geography', 'geo-germany', 'geography-germany', 'federal-states', 'Bundesländer', 'text', 3, 6, '{"checks":["single-place-answer"]}'::jsonb, 602),
  ('tpl-geo-europe', 'geography', 'geo-europe', 'geography-europe', 'europe', 'Europa', 'text', 4, 6, '{"checks":["single-place-answer"]}'::jsonb, 603),
  ('tpl-geo-scale-deep', 'geography', 'geo-scale', 'geography-scale', 'scale', 'Maßstab vertiefen', 'unit', 5, 6, '{"checks":["positive-scale","unit-accepted"]}'::jsonb, 604),
  ('tpl-cs-logic', 'computer-science', 'cs-patterns-topic', 'cs-patterns', 'logic', 'Logik', 'multiple-choice', 3, 6, '{"checks":["single-correct-option","choices-present"]}'::jsonb, 701),
  ('tpl-cs-algorithm-order', 'computer-science', 'cs-algorithms-topic', 'cs-algorithms', 'algorithms', 'Schritte sortieren', 'ordering', 3, 6, '{"checks":["unique-order","accepted-variants"]}'::jsonb, 702),
  ('tpl-cs-debugging', 'computer-science', 'cs-algorithms-topic', 'cs-algorithms', 'debugging', 'Fehler finden', 'multiple-choice', 4, 6, '{"checks":["single-correct-option","debugging-scenario"]}'::jsonb, 703),
  ('tpl-cs-data-sort', 'computer-science', 'cs-data-topic', 'cs-data', 'data', 'Daten sortieren', 'ordering', 4, 6, '{"checks":["unique-order","accepted-variants"]}'::jsonb, 704),
  ('tpl-cs-binary-deep', 'computer-science', 'cs-binary-topic', 'cs-binary', 'binary', 'Binärzahlen vertiefen', 'number', 5, 6, '{"checks":["binary-range","integer-answer"]}'::jsonb, 705)
on conflict (id) do update set
  subject_id = excluded.subject_id,
  topic_id = excluded.topic_id,
  module_id = excluded.module_id,
